...
public class NettyServerPipelineFactory{
    ...
    public ByteToMessageDecoder getDecoder(){
    	return new NettyTOMMessageDecoder(false, sessionTable,macLength,controller,rl,signatureLength,controller.getStaticConf().getUseMACs()==1?true:false,controller.getStaticConf().getDummyRequestMACs(), ncs);
    }
