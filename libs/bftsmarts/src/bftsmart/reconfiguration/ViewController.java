...
public class ViewController {
    ...
    public ViewController(int procId, String configHome, String hostsFileName) {
        this.staticConf = new TOMConfiguration(procId, configHome, hostsFileName);
        this.hostFileName = hostsFileName;
    }
    ...
    public final ViewStorage getViewStore() {
        if (this.viewStore == null) {
            ...
            String viewfile  = hostFileName + ".currentView";
            try {
                Class<? extends ViewStorage>       vscls = Class.forName( className ).asSubclass( ViewStorage.class );
                Constructor<? extends ViewStorage> vsctr = vscls.getConstructor( new Class[] { String.class } );
                this.viewStore = vsctr.newInstance( new Object[] { viewfile } );
            } catch (Exception e) {
                this.viewStore = new DefaultViewStorage( viewfile );
            }
