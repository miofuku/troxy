...
public class TOMConfiguration extends Configuration {
    ...
    private int useMACs;
    private boolean dummyRequestMACs;
    private boolean useClientSendLock;;
    ...
    protected void init() {
        ...
        try {
            ...
            s = configs.remove("system.numaddrs");
            if (s == null) {
                numAddresses = 1;
            } else {
                numAddresses = Integer.parseInt(s);
            }
            ...
            s = configs.remove("system.communication.dummyRequestMACs");
            if (s == null) {
                dummyRequestMACs = false;
            } else {
                dummyRequestMACs = Integer.parseInt(s)!=0;
            }

            s = configs.remove("system.communication.useClientSendLock");
            if (s == null) {
                useClientSendLock = true;
            } else {
                useClientSendLock = Integer.parseInt(s)!=0;
            }
    ...
    public boolean getDummyRequestMACs() {
        return dummyRequestMACs;
    }

    public boolean getUseClientSendLock() {
        return useClientSendLock;
    }
