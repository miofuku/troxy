...
public class ServiceProxy extends TOMSender {
    ...
    public ServiceProxy(int processId, String configHome, String hostsFileName) {
        this(processId, configHome, hostsFileName, null, null);
    }
    ...
    public ServiceProxy(int processId, String configHome, String hostsFileName,
        ...
        if (configHome == null) {
            ...
            init(processId, configHome, hostsFileName);
        }
