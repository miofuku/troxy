...
public class HybsterOrderMessages
{
    ...
    public static class HybsterPrepare extends AbstractOrderHolderMessage
    {
        ...
        public HybsterPrepare(short sender, long orderno, int viewno, CommandContainer cmd)
        {
    ...
    public static class HybsterCommit extends AbstractOrderHolderMessage
    {
        ...
        public HybsterCommit(short sender, long orderno, int viewno, CommandContainer command)
        {
            super( sender, orderno, viewno, command );
        }


        public HybsterCommit(short sender, long orderno, int viewno, Data data)
        {
