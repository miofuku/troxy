...
public class HybsterViewChangeHandler implements ProtocolHandler, MessageHandler<Message>,
                                                  LocalViewChangePreparationProtocol.Context
{
    ...
    private HybsterNewViewStable m_stableview = null;


    public HybsterViewChangeHandler(ChronosDomainContext cntxt, short shardno)
    {
        m_cntxt   = cntxt;
        m_shardno = shardno;
        m_locvc   = new HybsterLocalViewChangePreparationHandler( this );
        m_locsv   = HybsterLocalStableViewProtocol.Handler.createForLearner( this );
    }
    ...
    public HybsterNewViewStable getStableView()
    {
        return m_stableview;
    }
    ...
    {
        m_locvc.prepareOrderShard( prepset, orderno_last );
    ...
    private boolean handleLocalStableView(Message msg)
    {
        ...
        m_stableview = (HybsterNewViewStable) msg;
